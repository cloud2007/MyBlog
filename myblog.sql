...
CREATE TABLE IF NOT EXISTS `tcit_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='类别表' AUTO_INCREMENT=13 ;
...
(1, 1, 0, 1, '前端技术', 'UI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(2, 1, 0, 2, '后台编程', 'Development', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(3, 1, 0, 3, '数据库技术', 'DataBase', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(4, 1, 0, 4, '软件/工具', 'Tools', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(5, 1, 0, 5, '生活随笔', 'Blog', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(6, 1, 2, 5, 'PHP', 'PHP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(7, 1, 1, 0, 'Html', 'Html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(8, 1, 1, 0, 'CSS', 'CSS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(9, 1, 1, 0, 'Javascript', 'Javascript', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(10, 1, 1, 0, 'Jquery', 'Jquery', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(11, 1, 3, 0, 'Mysql', 'Mysql', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014),
(12, 1, 3, 0, 'Nosql', 'Nosql', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2014);
...
(11, 1, '文章管理', '文章类别', 2, 'Category', '', 'add', 'category', 1, 'creatTime|categoryTitle|categoryTitle1', '所属类别', '标题名称', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '详细内容', '', '', '', '', '', '上传图片', '上传大图', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '浏览次数', '类别名称', '英文名(链接名)', '', '', '', '', '', '', '', '', '', '姓名', '公司名称', '手机号', '电话号码', '传真号码', '附加图片', '电子邮件', '邮编', '地址', '', '', '', '', '', '', '', '', '', '', '创建时间'),
(12, 1, '文章管理', '添加文章', 1, 'News/add', 'News', 'add', 'news', 1, 'title|content|category|is_tj|is_gd|title1|creatTime', '所属类别', '标题名称', '关键词tags', '', '', '', '', '', '', '', '', '', '简介', '', '', '', '', '详细内容', '', '', '', '', '', '上传图片', '上传大图', '', '', '', '', '', '', '推荐', '固顶', '', '', '', '', '', '', '浏览次数', '类别名称', '', '', '', '', '', '', '', '', '', '', '姓名', '公司名称', '手机号', '电话号码', '传真号码', '附加图片', '电子邮件', '邮编', '地址', '', '', '', '', '', '', '', '', '', '', '创建时间');

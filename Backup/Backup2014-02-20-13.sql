CREATE TABLE `tcit_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='类别表';
insert into `tcit_category`(`id`,`lmID`,`parentID`,`orderNo`,`categoryTitle`,`categoryTitle1`,`categoryTitle2`,`categoryBremark`,`categoryName1`,`categoryName2`,`categorySmallPic`,`categoryBigPic`,`categoryContent1`,`categoryContent2`,`multiPic`,`creatTime`) values('1','1','0','1','前端技术','','','','','','','','','','','2014');
insert into `tcit_category`(`id`,`lmID`,`parentID`,`orderNo`,`categoryTitle`,`categoryTitle1`,`categoryTitle2`,`categoryBremark`,`categoryName1`,`categoryName2`,`categorySmallPic`,`categoryBigPic`,`categoryContent1`,`categoryContent2`,`multiPic`,`creatTime`) values('2','1','0','2','后台编程','','','','','','','','','','','2014');
insert into `tcit_category`(`id`,`lmID`,`parentID`,`orderNo`,`categoryTitle`,`categoryTitle1`,`categoryTitle2`,`categoryBremark`,`categoryName1`,`categoryName2`,`categorySmallPic`,`categoryBigPic`,`categoryContent1`,`categoryContent2`,`multiPic`,`creatTime`) values('3','1','0','3','数据库技术','','','','','','','','','','','2014');
insert into `tcit_category`(`id`,`lmID`,`parentID`,`orderNo`,`categoryTitle`,`categoryTitle1`,`categoryTitle2`,`categoryBremark`,`categoryName1`,`categoryName2`,`categorySmallPic`,`categoryBigPic`,`categoryContent1`,`categoryContent2`,`multiPic`,`creatTime`) values('4','1','0','4','软件/工具','','','','','','','','','','','2014');
insert into `tcit_category`(`id`,`lmID`,`parentID`,`orderNo`,`categoryTitle`,`categoryTitle1`,`categoryTitle2`,`categoryBremark`,`categoryName1`,`categoryName2`,`categorySmallPic`,`categoryBigPic`,`categoryContent1`,`categoryContent2`,`multiPic`,`creatTime`) values('5','1','0','5','生活随笔','','','','','','','','','','','2014');
insert into `tcit_category`(`id`,`lmID`,`parentID`,`orderNo`,`categoryTitle`,`categoryTitle1`,`categoryTitle2`,`categoryBremark`,`categoryName1`,`categoryName2`,`categorySmallPic`,`categoryBigPic`,`categoryContent1`,`categoryContent2`,`multiPic`,`creatTime`) values('6','1','2','5','PHP','','','','','','','','','','','2014');
insert into `tcit_category`(`id`,`lmID`,`parentID`,`orderNo`,`categoryTitle`,`categoryTitle1`,`categoryTitle2`,`categoryBremark`,`categoryName1`,`categoryName2`,`categorySmallPic`,`categoryBigPic`,`categoryContent1`,`categoryContent2`,`multiPic`,`creatTime`) values('7','1','1','0','Html','','','','','','','','','','','2014');
insert into `tcit_category`(`id`,`lmID`,`parentID`,`orderNo`,`categoryTitle`,`categoryTitle1`,`categoryTitle2`,`categoryBremark`,`categoryName1`,`categoryName2`,`categorySmallPic`,`categoryBigPic`,`categoryContent1`,`categoryContent2`,`multiPic`,`creatTime`) values('8','1','1','0','Css','','','','','','','','','','','2014');
insert into `tcit_category`(`id`,`lmID`,`parentID`,`orderNo`,`categoryTitle`,`categoryTitle1`,`categoryTitle2`,`categoryBremark`,`categoryName1`,`categoryName2`,`categorySmallPic`,`categoryBigPic`,`categoryContent1`,`categoryContent2`,`multiPic`,`creatTime`) values('9','1','1','0','Javascript','','','','','','','','','','','2014');
insert into `tcit_category`(`id`,`lmID`,`parentID`,`orderNo`,`categoryTitle`,`categoryTitle1`,`categoryTitle2`,`categoryBremark`,`categoryName1`,`categoryName2`,`categorySmallPic`,`categoryBigPic`,`categoryContent1`,`categoryContent2`,`multiPic`,`creatTime`) values('10','1','1','0','Jquery','','','','','','','','','','','2014');
...
CREATE TABLE `tcit_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='MENU菜单表';
...
insert into `tcit_user`(`id`,`userID`,`passWord`,`grantWord`,`status`,`creatTime`,`loginTime`) values('1','cloud','85b789dd35ccd43710c905d097732af1','ALL','1','1391998314','');
insert into `tcit_user`(`id`,`userID`,`passWord`,`grantWord`,`status`,`creatTime`,`loginTime`) values('2','admin','21232f297a57a5a743894a0e4a801fc3','ALL','1','1391837264','');
